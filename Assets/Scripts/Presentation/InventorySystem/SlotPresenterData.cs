...
{
    [CreateAssetMenu(fileName = "SlotPresenterData", menuName = "Dungeons/Presentation/InventorySystem/SlotPresenterData")]
    public class SlotPresenterData : ScriptableObject
    {
